...
describe('courseReducer', () => {
  ...
  it('should return the initial state when the action SELECT_COURSE is passed', () => {
    expect(courseReducer(undefined, { type: SELECT_COURSE }).toJS()).toEqual(initialState.toJS());
  });

  it('should return the initial state when the action UNSELECT_COURSE is passed', () => {
    expect(courseReducer(undefined, { type: UNSELECT_COURSE }).toJS()).toEqual(initialState.toJS());
  });
